...
namespace Misc
{
    public class Quantity
    {
        ...
        new string[]
        {
            ...
            "球面度", "人", "日", "勺", "摄氏度", "升", "十克", "十米", "十升", "石", "时",
            "市尺", "市斤", "市里", "市亩", "市升", "特", "特克斯", "特斯拉", "天", "天文单位",
        ...
        new string[]
        {
            ...
            "瓦图", "乌吉亚", "先令", "谢克尔", "新家坡元", "新台币", "新西兰元", "新元", "印度卢布", "英镑",
            "元", "越南盾", "扎伊尔", "铢","兹罗提"
        }.OrderByDescending(s => s.Length).ToArray();
